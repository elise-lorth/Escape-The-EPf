...
public class GameControlP : MonoBehaviour
{
    ...
    void Update()
    {
        if (photos[0].rotation.z == 0 && photos[1].rotation.z == 0 && photos[2].rotation.z == 0 && photos[3].rotation.z == 0 && photos[4].rotation.z == 0 && photos[5].rotation.z == 0 && photos[6].rotation.z == 0 && photos[7].rotation.z == 0 && photos[8].rotation.z == 0)
        {
            victoire=true;
    ...
    {
        SceneManager.LoadScene("puzzleRotationnelPeluches");
    }
