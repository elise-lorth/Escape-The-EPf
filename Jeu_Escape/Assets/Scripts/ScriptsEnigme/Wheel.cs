...
public class Wheel : MonoBehaviour
{
    ...
    [SerializeField]
	private GameObject panel, palier;
    ...
    public float victoryAngle = -150f;
    float wheelAngle = 0f;
    ...
    public float GetClampedValue()
    {
        ...
        return wheelAngle / maximumSteeringAngle/ victoryAngle;
    }
    ...
    public void DragEvent( BaseEventData eventData )
    {
       ...
       // wheelAngle = Mathf.Clamp( wheelAngle, -victoryAngle, victoryAngle );
       // {
       //     Debug.Log("yes");
       //     panel.SetActive(false);
        //}
